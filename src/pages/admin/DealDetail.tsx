              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="pb-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div><label className="text-xs mb-1 block" style={{ color: '#8A8A93' }}>Status</label><select value={editForm.status || ''} onChange={e => setEditForm({ ...editForm, status: e.target.value as any })} style={inpBase} {...inpFocus}><option value="Pipeline">Pipeline</option><option value="Reserve">Reserve</option><option value="Founding">Founding</option><option value="Deal done">Deal done</option><option value="Wait IPO">Wait IPO</option><option value="Lock-up">Lock-up</option><option value="Exit">Exit</option><option value="draft">Draft</option></select></div>
