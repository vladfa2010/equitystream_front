          ...
          <GlassCard>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <span
                ...
                style={{
                  background: form.role === 'admin' ? 'rgba(184,161,78,0.15)' : 'rgba(79,110,247,0.15)',
                  color: form.role === 'admin' ? '#B8A14E' : '#4F6EF7',
                  border: `1px solid ${form.role === 'admin' ? 'rgba(184,161,78,0.3)' : 'rgba(79,110,247,0.3)'}`,
                }}
              >
